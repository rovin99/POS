...
import CustomerModal from "../hooks/statusModal";
...
import CustomersOverBalance from "../hooks/Status/balancetracker/index";
import { formatToUrduNumeric, timeAgoInPKT } from "../../locales/format";
import { useUsers } from "../../fetch/userContext";
import CommentModal from "../hooks/Status/comments/CommentsModal"; 
import ShowCommentsModal from "../hooks/Status/comments/comments"; // Sørg for at stien matcher placeringen af din fil
